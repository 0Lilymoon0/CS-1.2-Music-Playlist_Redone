class Song:
  ...
  # TODO: Create a setter method for the next_song attribute, called set_title. Make sure titles are type casted to strings and are Title Cased.
  ...
  def __repr__(self):
    return f'Song Title: {self.get_title()}, --> Next Song Title: {self.get_next_song()}'